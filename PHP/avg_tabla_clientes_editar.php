...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <br><br>
            <form action="../PHP/avg_tabla_clientes_editarDatos.php" class="formulario" method="POST">
                ...
                <div class="formulario__grupo" id="iidcliente">
                    <label for="Nombre" class="formulario__label">Id Cliente</label>
                    <div class="formulario__grupo-input">
                        <input type="text" class="formulario__input" name="idcliente" id="idcliente"  readonly value="<?php echo $roww['idcliente'];?>">
                    </div>
                </div>    
                <div class="formulario__grupo" id="Nombre">
                    <label for="Nombre" class="formulario__label">Nombres</label>
                    <div class="formulario__grupo-input">
                        <input type="text" class="formulario__input" name="nomcliente" id="nomcliente"  placeholder="Ingrese el nombre del cliente" required value="<?php echo $roww['nomcliente'];?>">
                    </div>
                </div>
                <div class="formulario__grupo" id="Apellidos">
                    <label for="Apellidos" class="formulario__label">Apellidos</label>
                    <div class="formulario__grupo-input">
                        <input type="text" class="formulario__input" name="apecliente" id="apecliente"  placeholder="Ingrese el apellido del cliente" required value="<?php echo $roww['apecliente'];?>">
                    </div>
                </div>
                <!-- Grupo: Cedula -->
                <div class="formulario__grupo" id="Cedula">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="number" class="formulario__input" name="ceducliente" id="ceducliente" step="1" min="10000000" max="1999999999"placeholder="Ingresar numero sin puntos ni comas" required value="<?php echo $roww['ceducliente'];?>">
                    </div>
                </div>
                ...
                <div class="formulario__grupo" id="Celular">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="number" class="formulario__input" name="telcliente" id="telcliente"min="3002000000" max="3509999999" value required <?php echo $roww['telcliente'];?>">
                    </div>
                </div>
                <div class="formulario__grupo" id="Email">
                    <label for="Email" class="formulario__label">Email</label>
                    <div class="formulario__grupo-input">
                        <input type="email" class="formulario__input" name="corcliente" id="corcliente" required <?php echo $roww['corcliente'];?>">
                    </div>
                </div>
                <div class="formulario__grupo" id="Direccion">
                    <label for="Direccion" class="formulario__label">Direccion</label>
                    <div class="formulario__grupo-input">
                        <input type="text" class="formulario__input" name="dircliente" id="dircliente"  value required <?php echo $roww['dircliente'];?>">
                    </div>
                </div>
                
                <div class="formulario__grupo formulario__grupo-btn-enviar">
                    <button type="submit" class="formulario__btn">Actualizar Cliente</button>
