	...
	<main>
        ...
        <div class="formulario__grupo">
			...
			<div class="formulario__grupo" id="Temperatura">
				<label for="Temperatura" class="formulario__label">Fecha registro salida</label>
            ...
            <div class="formulario__grupo">
                ...
                <select>
                <option selected disabled>Seleccione un tipo de salida</option>
            <?php
            require("../conexion.php");
            ...
            try {
                ...
                $query = "SELECT * FROM tiposalida ORDER BY idtiposalida";
                $stmt = $conexion->prepare($query);
                $stmt->execute();


                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    $idtiposalida = $row['idtiposalida'];
                    $nomtiposalida = $row['nomtiposalida'];
                    echo "<option value=\"$idtiposalida\">$nomtiposalida</option>";
                }
            } catch (PDOException $e) {
                echo "Error: " . $e->getMessage();
            }
			...
			<div class="formulario__grupo formulario__grupo-btn-enviar">
                <br><br>
				<button type="submit" class="formulario__btn">Guardar salida</button>
			</div>
		</form>
	</main>
</body>
